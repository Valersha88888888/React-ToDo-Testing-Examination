...
För integrationstestet använde jag MSW för att mocka Open-Meteo. Testet kontrollerar att getStockholmWeather returnerar temperature och weatherCode som numeriska värden. Jag använde mocking för att testet inte skulle bero på verkligt väder eller på att Open-Meteo alltid är tillgängligt.
